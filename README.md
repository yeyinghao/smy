...
```shell
mvn archetype:generate  -DgroupId=com.amos -DartifactId=app -Dversion=1.0.0-SNAPSHOT -Dpackage=com.amos.app -DarchetypeArtifactId=cola-framework-archetype-web -DarchetypeGroupId=com.alibaba.cola -DarchetypeVersion=4.0.0
```
